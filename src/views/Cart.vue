              ...
              <li v-for="(item,key) in cartList">
                <div class="cart-tab-1">
                  <div class="cart-item-check">
                    <a href="javascipt:;" class="checkbox-btn item-check-btn" v-bind:class="{'check':item.checked=='1'}" @click="editCart('checkecd',item)">
                  ...
                  <div class="cart-item-pic">
                    <img :src="'/static/img/'+item.productImage" v-bind:alt="item.productName">
                  </div>
